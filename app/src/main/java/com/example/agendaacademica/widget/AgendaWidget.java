package com.example.agendaacademica.widget;
...
import com.example.agendaacademica.activities.MainActivity;
...
public class AgendaWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        // Click en refrescar
        Intent refreshIntent = new Intent(context, AgendaWidget.class);
        ...
        Intent detailIntent = new Intent(context, com.example.agendaacademica.activities.DetalleEventoActivity.class);
