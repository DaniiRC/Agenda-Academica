...
import com.example.agendaacademica.activities.EditarPerfilActivity;
import com.example.agendaacademica.activities.LoginActivity;
...
public class PerfilFragment extends Fragment {
    ...
    private void cargarEstadisticas() {
        ...
        apiService.obtenerGruposDeUsuario(usuarioId).enqueue(new Callback<List<com.example.agendaacademica.model.Grupo>>() {
            ...
            @Override
            public void onFailure(Call<List<com.example.agendaacademica.model.Grupo>> call, Throwable t) {
                if (swipeRefresh != null) swipeRefresh.setRefreshing(false);
                if (!isAdded()) return;
