...
import com.example.edusync.activities.PerfilClaseActivity;
...
public class GrupoAdapter extends RecyclerView.Adapter<GrupoAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final Grupo grupo) {
            ...
            com.example.edusync.SessionManager session = new com.example.edusync.SessionManager(itemView.getContext());
            ...
            com.example.edusync.utils.GlideUtils.cargarFotoGrupo(itemView.getContext(), fotoUrl, ivFoto);
